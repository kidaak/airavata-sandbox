<?php
	...
	$id=$_GET["id"];
	$ui_url=attachToCurrentURLInPath("OrUI.php");
	$ui_factory_url=attachToCurrentURLInPath("OrFactoryUI.php");
?>
<script>
	
	function OrComponent(id, type){
		var objSelf = this;
		this.id=id;
	...
	workspace.addComponentFactory(new OrComponentFactory("<?php echo $id ?>"));
</script>
